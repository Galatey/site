<template>
  ...
  <div class="carusel">
    <el-carousel :interval="8000" type="card">
      <el-carousel-item v-for="item in products" :key="item.id">
        <img @click="show = true" @:click="pic = item" :src="item.image" alt="">
      </el-carousel-item>
    </el-carousel>
  </div>
  <el-divider class="divider" />
  ...
  <div class="otdelka">
    <div class="ottdelka_foto">
      <el-image style="width: 100%; height: 100%" src="https://pro-dachnikov.com/uploads/posts/2023-01/1673061517_pro-dachnikov-com-p-otdelka-doma-iz-brusa-vnutri-foto-72.jpg" fit="cover" />
    </div>
  ...
  <div class="stroy">
    <div class="stroy_info">
      <p>Монтаж отопительного оборудования</p>
    </div>
    <div class="stroy_foto">
      <el-image style="width: 100%; height: 100%" src="https://pro-dachnikov.com/uploads/posts/2021-10/1633808676_74-pro-dachnikov-com-p-sistema-otopleniya-v-chastnom-dome-foto-78.jpg" fit="cover" />
    </div>
  </div>
  <el-divider class="divider" />
  <div class="otdelka">
    <div class="ottdelka_foto">
      <el-image style="width: 100%; height: 100%" src="https://avatars.mds.yandex.net/i?id=f7bf20a02d9fe6cbea2286e9d8a8c855497b9145-4810024-images-thumbs&n=13" fit="cover" />
    </div>
    <div class="otdelka_info">
      <p>Земляные работы любой сложности</p>
    </div>
  </div>
  <el-divider class="divider" />
  <div class="stroy">
    <div class="stroy_info">
      <p>Монтаж очисных сооружений</p>
    </div>
    <div class="stroy_foto">
      <el-image style="width: 100%; height: 100%" src="https://avatars.mds.yandex.net/i?id=1e503a8e346ad170f253a6fc03e46b724e785581-8568171-images-thumbs&n=13" fit="cover" />
    </div>
  </div>
  <el-divider class="divider" />
  <div class="otdelka">
